...
public class 場景1結尾轉換 : MonoBehaviour
{
    void Start()
    {
    ...
    public GameObject ChangePointToScene2;
    public GameObject ChangePointToScene3;
    Story story = null;
    ...
    public void NextDialog()
    {
        ...
        { //如果story不能繼續 && 沒有選項，則代表對話結束
            ...
            story = null;
            ChangePointToScene2.SetActive(true);
            ChangePointToScene3.SetActive(true);
            return;
        }
